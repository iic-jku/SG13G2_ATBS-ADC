...
#                script (type 'tbs_core_all_board.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tbs_core_all_board xil_defaultlib.glbl -o tbs_core_all_board_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tbs_core_all_board_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tbs_core_all_board_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tbs_core_all_board_simv.daidir vcs_lib c.obj)
