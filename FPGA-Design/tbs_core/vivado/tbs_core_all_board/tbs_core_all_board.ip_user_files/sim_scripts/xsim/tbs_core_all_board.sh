...
#
# Script generated by Vivado on Tue Mar 25 12:44:21 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tbs_core_all_board.sh
...
#
# Usage        : tbs_core_all_board.sh
#                tbs_core_all_board.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tbs_core_all_board.sh [-reset_run]
#                tbs_core_all_board.sh [-reset_log]
#                tbs_core_all_board.sh [-help]
#
...
# script info
echo -e "tbs_core_all_board.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tbs_core_all_board.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tbs_core_all_board xil_defaultlib.tbs_core_all_board xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tbs_core_all_board -key {Behavioral:sim_1:Functional:tbs_core_all_board} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tbs_core_all_board.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tbs_core_all_board.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tbs_core_all_board.sh [-help]\n\
Usage: tbs_core_all_board.sh [-step]\n\
Usage: tbs_core_all_board.sh [-lib_map_path]\n\
Usage: tbs_core_all_board.sh [-reset_run]\n\
Usage: tbs_core_all_board.sh [-reset_log]\n\
Usage: tbs_core_all_board.sh [-keep_index]\n\
Usage: tbs_core_all_board.sh [-noclean_files]\n\n\
