...
#
# Script generated by Vivado on Tue Mar 25 12:52:05 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tbs_core_pwm_board.sh
...
#
# Usage        : tbs_core_pwm_board.sh
#                tbs_core_pwm_board.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tbs_core_pwm_board.sh [-reset_run]
#                tbs_core_pwm_board.sh [-reset_log]
#                tbs_core_pwm_board.sh [-help]
#
...
#                script (type 'tbs_core_pwm_board.sh -help' for more information).
#
...
# script info
echo -e "tbs_core_pwm_board.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tbs_core_pwm_board.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tbs_core_pwm_board xil_defaultlib.glbl -o tbs_core_pwm_board_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tbs_core_pwm_board_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tbs_core_pwm_board_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tbs_core_pwm_board_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tbs_core_pwm_board.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tbs_core_pwm_board.sh [-help]\n\
Usage: tbs_core_pwm_board.sh [-step]\n\
Usage: tbs_core_pwm_board.sh [-lib_map_path]\n\
Usage: tbs_core_pwm_board.sh [-reset_run]\n\
Usage: tbs_core_pwm_board.sh [-reset_log]\n\
Usage: tbs_core_pwm_board.sh [-keep_index]\n\
Usage: tbs_core_pwm_board.sh [-noclean_files]\n\n\
