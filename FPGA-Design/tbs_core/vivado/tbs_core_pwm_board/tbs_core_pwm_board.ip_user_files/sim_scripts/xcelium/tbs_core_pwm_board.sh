...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tbs_core_pwm_board xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tbs_core_pwm_board -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tbs_core_pwm_board_sc.so .tmp_log xcelium_lib waves.shm c.obj)
