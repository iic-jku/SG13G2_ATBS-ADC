...
HD_PWD='C:/Simon Dorrer/JKU-Linz/Master/Semester 2/Master-Thesis/FPGA-Design/tbs_core/vivado/tbs_core_pwm_board/tbs_core_pwm_board.runs/pll_8MHz_synth_1'
cd "$HD_PWD"
