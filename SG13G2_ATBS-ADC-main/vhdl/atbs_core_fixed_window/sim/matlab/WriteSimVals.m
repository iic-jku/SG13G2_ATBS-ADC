...
vhdl_src_path, package_prefix)
    ...
    sc_noc_1_counter_bitwidth = ceil(log2(sc_noc_1_counter_max));
    sc_noc_2_counter_bitwidth = ceil(log2(sc_noc_2_counter_max));
    uart_baud_counter_bitwidth = ceil(log2(uart_baud_counter_max));
    
    % package content
    fprintf(f, '-------------------------------------------------------------------------------------------- \n');
    fprintf(f, '-- Author: Simon Dorrer \n');
    fprintf(f, '-- Last Modified: 23.03.2025 \n');
    ...
    fprintf(f, '  -- SC NOC GENERATOR 1 CONSTANTS\n');
    fprintf(f, '  -- ===================================================== \n');
    fprintf(f, '  constant SC_NOC_1_COUNTER_BITWIDTH : natural := %u;\n', sc_noc_1_counter_bitwidth);
    fprintf(f, '  constant SC_NOC_1_COUNTER_MAX : natural := %u;\n', sc_noc_1_counter_max);
    fprintf(f, '  -- ===================================================== \n\n');
    
    fprintf(f, '  -- SC NOC GENERATOR 2 CONSTANTS\n');
    fprintf(f, '  -- ===================================================== \n');
    fprintf(f, '  constant SC_NOC_2_COUNTER_BITWIDTH : natural := %u;\n', sc_noc_2_counter_bitwidth);
    fprintf(f, '  constant SC_NOC_2_COUNTER_MAX : natural := %u;\n', sc_noc_2_counter_max);
    fprintf(f, '  -- ===================================================== \n\n');
