...
add wave -noupdate /sc_noc_generator_tb/SC_NOC_1_COUNTER_MAX
...
WaveRestoreCursors {{Cursor 1} {64250000 ps} 0} {{Cursor 2} {80125000 ps} 0} {{Cursor 3} {96250000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1680918750 ps}
