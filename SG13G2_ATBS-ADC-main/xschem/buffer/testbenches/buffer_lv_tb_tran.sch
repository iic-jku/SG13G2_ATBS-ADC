...
logy=0
linewidth_mult=4}
T {Testbench for transient analysis - LV Buffer} 690 -1720 0 0 1 1 {}
N 1260 -700 1260 -660 {
lab=GND}
N 840 -840 840 -780 {
lab=vin}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/buffer_lv_tb_tran.raw tran"
}
...
C {buffer/buffer_lv.sym} 1060 -840 0 0 {name=x1 W_P_INV=1.0u L_P_INV=0.13u W_N_INV=1.0u L_N_INV=0.13u}
