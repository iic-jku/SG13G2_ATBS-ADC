...
hilight_wave=-1
linewidth_mult=4}
T {Testbench for transient analysis - Programmable Capacitor} 560 -1690 0 0 1 1 {}
...
C {devices/vsource.sym} 880 -610 0 0 {name=vin value="sin(0.75 100m 500)"}
...
"}
C {devices/launcher.sym} 1620 -1030 0 0 {name=h2
descr="Simulate" 
tclcommand="xschem save; xschem netlist; xschem simulate"
}
C {devices/launcher.sym} 1620 -910 0 0 {name=h1
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/programmable_cap_tb_tran.raw tran"
}
C {devices/launcher.sym} 1620 -970 0 0 {name=h3
descr="Annotate OP" 
...
op
remzerovec
write programmable_cap_tb_tran.raw
set appendwrite
