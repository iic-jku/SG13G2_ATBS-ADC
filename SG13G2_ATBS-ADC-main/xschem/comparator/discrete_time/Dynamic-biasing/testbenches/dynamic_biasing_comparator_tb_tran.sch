...
T {Testbench for transient analysis - DT dynamic-biasing comparator} 440 -1710 0 0 1 1 {}
...
C {devices/code_shown.sym} 40 -1530 0 0 {name=MODEL only_toplevel=true
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/dynamic_biasing_comparator_tb_tran.raw tran"
}
C {devices/launcher.sym} 1720 -1300 0 0 {name=h3
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {code_shown.sym} 40 -1370 0 0 {name=NGSPICE
only_toplevel=true
value="
.param temp=27
.param fclk=8000000
...
C {comparator/discrete_time/Dynamic-biasing/dynamic_biasing_comparator.sym} 1140 -720 0 0 {name=x1}
