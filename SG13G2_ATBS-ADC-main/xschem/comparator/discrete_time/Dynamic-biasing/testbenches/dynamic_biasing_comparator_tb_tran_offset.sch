...
T {Testbench for Offset analysis - DT dynamic-biasing comparator} 480 -1710 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/dynamic_biasing_comparator_tb_tran_offset.raw tran"
}
...
.csparam Vcm=Vcm
.options klu method=gear reltol=1e-3 abstol=1e-12 gmin=1e-15
.control
* save all
...
op
remzerovec
write dynamic_biasing_comparator_tb_tran_offset.raw
set appendwrite
...
set wr_singlescale
set wr_vecnames
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/dynamic_biasing_comparator_tb_tran_offset.txt v(clk) v(voutp) v(voutn) v(vinp) v(vinn)
...
C {comparator/discrete_time/Dynamic-biasing/dynamic_biasing_comparator.sym} 1140 -780 0 0 {name=x1}
