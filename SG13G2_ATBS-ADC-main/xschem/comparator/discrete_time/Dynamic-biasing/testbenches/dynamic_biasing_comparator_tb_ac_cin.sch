...
T {Testbench for Input Capacitance analysis - DT dynamic-biasing comparator} 360 -1700 0 0 1 1 {}
...
C {devices/code_shown.sym} 60 -1290 0 0 {name=MODEL only_toplevel=true
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/dynamic_biasing_comparator_tb_ac_cin.raw ac"
}
...
op
remzerovec
write dynamic_biasing_comparator_tb_ac_cin.raw
set appendwrite
...
set wr_singlescale
set wr_vecnames
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/dynamic_biasing_comparator_tb_ac_cin.txt v(Cinp) v(Cinn)
...
C {comparator/discrete_time/Dynamic-biasing/dynamic_biasing_comparator.sym} 1180 -720 0 0 {name=x1}
