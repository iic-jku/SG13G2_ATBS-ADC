...
T {Testbench for Input Capacitance analysis - DT StrongARM comparator} 360 -1700 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/StrongARM_comparator_tb_ac_cin.raw ac"
}
...
op
remzerovec
write StrongARM_comparator_tb_ac_cin.raw
set appendwrite
...
*quit
.endc"}
C {devices/vsource.sym} 1160 -1050 0 0 {name=V1 value=1.5}
C {devices/vdd.sym} 1160 -860 0 0 {name=l1 lab=VDD}
C {devices/gnd.sym} 1160 -560 0 0 {name=l2 lab=GND}
C {devices/lab_wire.sym} 1240 -580 2 0 {name=l4 sig_type=std_logic lab=clk}
...
C {devices/gnd.sym} 1160 -980 0 0 {name=l13 lab=GND}
C {devices/lab_wire.sym} 1160 -1120 0 1 {name=l14 sig_type=std_logic lab=clk}
...
C {comparator/discrete_time/StrongARM/StrongARM_comparator.sym} 1180 -720 0 0 {name=x1}
