...
T {Testbench for transient analysis - DT StrongARM comparator} 440 -1710 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/StrongARM_comparator_tb_tran.raw tran"
}
...
*quit
.endc"}
C {devices/vsource.sym} 1120 -1050 0 0 {name=V1 value="pulse(0 1.5 \{tstart\} 10p 10p \{1/fclk\} \{1/fphi\})"}
C {devices/vdd.sym} 1120 -860 0 0 {name=l1 lab=VDD}
C {devices/gnd.sym} 1120 -560 0 0 {name=l2 lab=GND}
C {devices/lab_wire.sym} 1200 -580 2 0 {name=l4 sig_type=std_logic lab=clk}
...
C {devices/gnd.sym} 1120 -980 0 0 {name=l13 lab=GND}
C {devices/lab_wire.sym} 1120 -1120 0 1 {name=l14 sig_type=std_logic lab=clk}
...
C {comparator/discrete_time/StrongARM/StrongARM_comparator.sym} 1140 -720 0 0 {name=x1}
