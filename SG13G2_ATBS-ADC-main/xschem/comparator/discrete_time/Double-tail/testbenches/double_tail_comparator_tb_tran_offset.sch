...
T {Testbench for Offset analysis - DT double-tail comparator} 480 -1710 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/double_tail_comparator_tb_tran_offset.raw tran"
}
...
op
remzerovec
write double_tail_comparator_tb_tran_offset.raw
set appendwrite
...
C {comparator/discrete_time/Double-tail/double_tail_comparator.sym} 1140 -780 0 0 {name=x1}
