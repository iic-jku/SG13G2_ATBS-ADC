...
T {Testbench for transient analysis - DT double-tail comparator} 440 -1710 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/double_tail_comparator_tb_tran.raw tran"
}
...
op
remzerovec
write double_tail_comparator_tb_tran.raw
set appendwrite
...
C {comparator/discrete_time/Double-tail/double_tail_comparator.sym} 1140 -720 0 0 {name=x1}
