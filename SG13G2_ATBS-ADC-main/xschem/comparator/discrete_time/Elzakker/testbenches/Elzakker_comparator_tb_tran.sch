...
T {Testbench for transient analysis - DT Elzakker comparator} 440 -1710 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/Elzakker_comparator_tb_tran.raw tran"
}
C {devices/launcher.sym} 1720 -1300 0 0 {name=h3
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {code_shown.sym} 40 -1350 0 0 {name=NGSPICE
only_toplevel=true
value="
.param temp=27
.param fclk=8000000
...
op
remzerovec
write Elzakker_comparator_tb_tran.raw
set appendwrite
...
let vcpp=x1.vcpp
let vcpn=x1.vcpn
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/Elzakker_comparator_tb_tran.txt v(clk) v(vs) v(vcpp) v(vcpn) v(voutp) v(voutn)
...
C {comparator/discrete_time/Elzakker/Elzakker_comparator.sym} 1140 -720 0 0 {name=x1}
