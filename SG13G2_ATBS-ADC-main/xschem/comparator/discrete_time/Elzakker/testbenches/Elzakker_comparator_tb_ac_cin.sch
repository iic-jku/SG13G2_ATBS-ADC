...
T {Testbench for Input Capacitance analysis - DT Elzakker comparator} 360 -1700 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/Elzakker_comparator_tb_ac_cin.raw ac"
}
...
op
remzerovec
write Elzakker_comparator_tb_ac_cin.raw
set appendwrite
...
set wr_singlescale
set wr_vecnames
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/Elzakker_comparator_tb_ac_cin.txt v(Cinp) v(Cinn)
...
C {comparator/discrete_time/Elzakker/Elzakker_comparator.sym} 1180 -720 0 0 {name=x1}
