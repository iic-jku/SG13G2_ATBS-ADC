...
T {Testbench for transient analysis - Common-Source Amplifier (high gm, high output voltage swing)} 480 -2370 0 0 1 1 {}
...
C {devices/code_shown.sym} 60 -1990 0 0 {name=NGSPICE
only_toplevel=true 
value="
.param temp=27
.param fclk=8000000
...
op
remzerovec
write common_source_amplifier_tb_tran.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/common_source_amplifier_tb_tran.txt v(vind) v(vout2) v(vinp) v(vinn) v(voutp2) v(voutn2)
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/common_source_amplifier_tb_tran.raw tran"
}
C {devices/launcher.sym} 2500 -2100 0 0 {name=h3
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {devices/code_shown.sym} 60 -2150 0 0 {name=MODEL only_toplevel=true
...
C {devices/gnd.sym} 1920 -1820 0 0 {name=l40 lab=GND}
...
C {devices/gnd.sym} 1980 -260 0 0 {name=l32 lab=GND}
C {devices/lab_pin.sym} 1980 -400 1 0 {name=l33 sig_type=std_logic lab=Vcm
}
...
C {bio_amplifier/amplifier_core/common_source_amplifier/common_source_amplifier_simplified.sym} 1700 -1440 0 0 {name=x1}
C {bio_amplifier/amplifier_core/common_source_amplifier/common_source_amplifier.sym} 1700 -860 0 0 {name=x2}
