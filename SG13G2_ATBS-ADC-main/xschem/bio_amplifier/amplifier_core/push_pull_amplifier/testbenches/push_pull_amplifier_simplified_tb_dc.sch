...
T {Testbench for DC analysis - Push-Pull Amplifier (high gm, high output voltage swing)} 150 -1710 0 0 1 1 {}
T {Capacitive Load (Comparator, DAC, etc.)} 1290 -650 0 0 0.25 0.25 {}
N 1460 -1380 1460 -1340 {lab=VDD}
...
N 880 -1380 920 -1380 {lab=VDD}
N 880 -1520 880 -1380 {lab=VDD}
N 880 -1520 1060 -1520 {lab=VDD}
N 1060 -1520 1060 -1480 {lab=VDD}
N 1060 -1560 1060 -1520 {lab=VDD}
N 1060 -1280 1060 -1240 {lab=GND}
N 1200 -1400 1240 -1400 {lab=Vbiasc}
N 1200 -1360 1240 -1360 {lab=Vbias}
...
op
remzerovec
write push_pull_amplifier_simplified_tb_dc.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/push_pull_amplifier_simplified_tb_dc.txt v(vinp) v(voutp)
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/push_pull_amplifier_simplified_tb_dc.raw dc"
}
...
"}
C {devices/vsource.sym} 1460 -1310 0 0 {name=VDD value=1.5}
C {devices/gnd.sym} 1460 -1240 0 0 {name=l3 lab=GND}
C {vdd.sym} 1460 -1380 0 0 {name=l7 lab=VDD}
...
C {vdd.sym} 1060 -1100 0 0 {name=l1 lab=VDD}
C {vdd.sym} 1000 -1100 0 0 {name=l4 lab=VDD}
C {devices/gnd.sym} 1000 -680 0 0 {name=l12 lab=GND}
C {bio_amplifier/amplifier_core/push_pull_amplifier/push_pull_amplifier_simplified.sym} 1080 -900 0 0 {name=x1}
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_2/bias_circuit_2.sym} 1060 -1380 0 0 {name=x2}
C {vdd.sym} 1060 -1560 0 0 {name=l19 lab=VDD}
C {devices/gnd.sym} 1060 -1240 0 0 {name=l20 lab=GND}
C {devices/lab_pin.sym} 1240 -1400 0 1 {name=l21 sig_type=std_logic lab=Vbiasc}
C {devices/lab_pin.sym} 1240 -1360 0 1 {name=l22 sig_type=std_logic lab=Vbias}
C {devices/lab_pin.sym} 1100 -1040 1 0 {name=l6 sig_type=std_logic lab=Vbiasc}
