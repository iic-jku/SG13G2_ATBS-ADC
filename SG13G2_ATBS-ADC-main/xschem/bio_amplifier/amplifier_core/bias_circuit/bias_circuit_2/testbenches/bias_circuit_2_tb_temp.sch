...
color=4
node=i(Vx)}
T {Testbench for temperature sweep - Bias Circuit v2} 520 -1690 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/bias_circuit_2_tb_temp.raw dc"
}
C {devices/launcher.sym} 1720 -1390 0 0 {name=h3
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {code_shown.sym} 60 -1350 0 0 {name=NGSPICE
only_toplevel=true
value="
.param temp=27
...
op
remzerovec
write bias_circuit_2_tb_temp.raw
set appendwrite
...
set wr_singlescale
let Ix=i(Vx)
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/bias_circuit_2_tb_temp.txt v(Vbias) v(Ix)
...
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_2/bias_circuit_2.sym} 1140 -900 0 0 {name=x1}
