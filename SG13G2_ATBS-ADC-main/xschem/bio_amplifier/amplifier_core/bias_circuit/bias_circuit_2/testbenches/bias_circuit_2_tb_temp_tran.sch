...
color=4
node=i(Vx)}
T {Testbench for looped-transient temperature sweep - Bias Circuit v2} 380 -1710 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/bias_circuit_2_tb_temp_tran.raw tran"
}
...
foreach temp_val $&temp_vec
  ...
  * Transient Analysis
  ...
  write bias_circuit_2_tb_temp_tran.raw
  set appendwrite
...
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_2/bias_circuit_2.sym} 1120 -980 0 0 {name=x1}
