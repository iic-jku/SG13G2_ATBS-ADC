...
node=i(Vx)
sweep=Vout}
T {Testbench for DC sweep - Bias Circuit v2} 670 -1740 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/bias_circuit_2_tb_dc.raw dc"
}
C {devices/launcher.sym} 1700 -1570 0 0 {name=h3
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {code_shown.sym} 60 -1270 0 0 {name=NGSPICE
only_toplevel=true
value="
.param temp=27
...
op
remzerovec
write bias_circuit_2_tb_dc.raw
set appendwrite
...
* Plotting
plot v(Vbiasc) v(Vbias) xlabel "VDD"
...
let Iref=i(v.x1.viref)
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/bias_circuit_2_tb_dc.txt v(Vbiasc) v(Vbias) v(Ix) v(Iout) v(Iref)
...
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_2/bias_circuit_2.sym} 1100 -800 0 0 {name=x1}
