...
T {Testbench for PSRR analysis - Bias Circuit v2} 640 -1690 0 0 1 1 {}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/bias_circuit_2_tb_PSRR.raw ac"
}
...
op
remzerovec
write bias_circuit_2_tb_PSRR.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/bias_circuit_2_tb_PSRR.txt v(PSRR_dB)
...
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_2/bias_circuit_2.sym} 1260 -820 0 0 {name=x1}
