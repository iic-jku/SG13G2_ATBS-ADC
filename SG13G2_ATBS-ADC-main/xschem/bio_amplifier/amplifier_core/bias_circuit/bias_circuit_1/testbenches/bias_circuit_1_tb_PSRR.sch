...
T {Testbench for PSRR analysis - Bias Circuit v1} 640 -1690 0 0 1 1 {}
N 1260 -940 1260 -920 {lab=VDD}
N 1260 -720 1260 -620 {lab=GND}
N 1040 -820 1120 -820 {lab=bias_en}
N 1040 -820 1040 -740 {lab=bias_en}
N 1040 -680 1040 -620 {lab=GND}
N 1400 -820 1480 -820 {lab=Vbias}
...
C {devices/code_shown.sym} 100 -1250 0 0 {name=MODEL only_toplevel=true
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/bias_circuit_1_tb_PSRR.raw ac"
}
C {devices/launcher.sym} 1660 -1110 0 0 {name=h3
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {code_shown.sym} 100 -1070 0 0 {name=NGSPICE
only_toplevel=true
value="
.param temp=27
...
op
remzerovec
write bias_circuit_1_tb_PSRR.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/bias_circuit_1_tb_PSRR.txt v(PSRR_dB)
...
C {devices/vdd.sym} 1260 -940 0 0 {name=l13 lab=VDD}
C {devices/vsource.sym} 760 -670 0 0 {name=VDD value=1.5}
C {devices/lab_wire.sym} 1480 -820 2 0 {name=p3 sig_type=std_logic lab=Vbias}
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_1/bias_circuit_1.sym} 1260 -820 0 0 {name=x1}
