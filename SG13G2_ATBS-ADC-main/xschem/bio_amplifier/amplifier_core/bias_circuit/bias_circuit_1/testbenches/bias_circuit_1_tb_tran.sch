...
color=4
node=i(Vx)}
T {Testbench for transient analysis - Bias Circuit v1} 520 -1750 0 0 1 1 {}
N 640 -660 640 -600 {lab=GND}
N 640 -780 640 -720 {lab=VDD}
N 1060 -700 1060 -600 {lab=GND}
N 1240 -800 1240 -760 {lab=Vbias}
N 1200 -800 1240 -800 {lab=Vbias}
N 1340 -700 1340 -600 {lab=GND}
N 1400 -800 1480 -800 {lab=GND}
N 1480 -800 1480 -600 {lab=GND}
N 1340 -940 1340 -900 {lab=#net1}
N 1340 -1040 1340 -1000 {lab=VDD}
...
C {devices/code_shown.sym} 100 -410 0 0 {name=MODEL only_toplevel=true
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/bias_circuit_1_tb_tran.raw tran"
}
C {devices/launcher.sym} 1680 -1570 0 0 {name=h3
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {code_shown.sym} 100 -1470 0 0 {name=NGSPICE
only_toplevel=true
value="
.param temp=27
...
op
remzerovec
write bias_circuit_1_tb_tran.raw
set appendwrite
...
meas tran tsettle WHEN i(v.x1.viout)=Iout_99_percent from=10e-6 to=1e-3 rise=2
...
C {devices/vdd.sym} 1060 -1040 0 0 {name=l13 lab=VDD}
C {devices/lab_wire.sym} 1240 -760 2 1 {name=p3 sig_type=std_logic lab=Vbias}
C {stacked_transistors/sg13g2_lv_nmos_stacked/sg13g2_lv_nmos_stacked_x4.sym} 1340 -800 0 0 {name=xMx W_N=5.0u L_N=40.0u NG_N=5 M_N=1}
C {devices/gnd.sym} 1340 -600 0 0 {name=l3 lab=GND}
C {devices/gnd.sym} 1480 -600 0 0 {name=l4 lab=GND}
C {devices/vsource.sym} 1340 -970 0 0 {name=Vx value=0.5}
C {devices/vdd.sym} 1340 -1040 0 0 {name=l5 lab=VDD}
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_1/bias_circuit_1.sym} 1060 -800 0 0 {name=x1}
