...
color=4
node=i(Vx)}
T {Testbench for temperature sweep - Bias Circuit v1} 520 -1690 0 0 1 1 {}
...
N 1320 -900 1320 -860 {lab=Vbias}
N 1280 -900 1320 -900 {lab=Vbias}
N 1420 -800 1420 -700 {lab=GND}
N 1480 -900 1560 -900 {lab=GND}
N 1560 -900 1560 -700 {lab=GND}
N 1420 -1040 1420 -1000 {lab=#net1}
N 1420 -1140 1420 -1100 {lab=VDD}
N 1320 -900 1360 -900 {lab=Vbias}
N 1140 -1140 1140 -1000 {lab=VDD}
C {devices/vsource.sym} 920 -790 0 0 {name=Ven value=1.5}
C {devices/gnd.sym} 920 -700 0 0 {name=l6 lab=GND}
C {devices/code_shown.sym} 60 -1550 0 0 {name=MODEL only_toplevel=true
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/bias_circuit_1_tb_temp.raw dc"
}
...
op
remzerovec
write bias_circuit_1_tb_temp.raw
set appendwrite
...
set wr_singlescale
let Ix=i(Vx)
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/bias_circuit_1_tb_temp.txt v(Vbias) v(Ix)
...
C {devices/vdd.sym} 1140 -1140 0 0 {name=l13 lab=VDD}
C {devices/vsource.sym} 680 -790 0 0 {name=VDD value=1.5}
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_1/bias_circuit_1.sym} 1140 -900 0 0 {name=x1}
C {devices/lab_wire.sym} 1320 -860 2 1 {name=p1 sig_type=std_logic lab=Vbias}
C {stacked_transistors/sg13g2_lv_nmos_stacked/sg13g2_lv_nmos_stacked_x4.sym} 1420 -900 0 0 {name=xMx W_N=5.0u L_N=40.0u NG_N=5 M_N=1}
C {devices/gnd.sym} 1420 -700 0 0 {name=l3 lab=GND}
C {devices/gnd.sym} 1560 -700 0 0 {name=l4 lab=GND}
C {devices/vsource.sym} 1420 -1070 0 0 {name=Vx value=0.5}
C {devices/vdd.sym} 1420 -1140 0 0 {name=l5 lab=VDD}
