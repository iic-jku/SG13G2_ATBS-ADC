...
color=4
node=i(Vx)}
T {Testbench for transient analysis - Bias Circuit v3} 520 -1750 0 0 1 1 {}
...
C {devices/code_shown.sym} 140 -410 0 0 {name=MODEL only_toplevel=true
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/bias_circuit_3_tb_tran.raw tran"
}
...
op
remzerovec
write bias_circuit_3_tb_tran.raw
set appendwrite
...
meas tran tsettle WHEN i(v.x1.viout)=Iout_99_percent
...
C {bio_amplifier/amplifier_core/bias_circuit/bias_circuit_3/bias_circuit_3.sym} 1060 -800 0 0 {name=x1}
