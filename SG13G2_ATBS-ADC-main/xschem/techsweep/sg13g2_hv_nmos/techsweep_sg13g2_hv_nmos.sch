...
S {}
E {}
T {Techsweep for the SG13G2 HV NMOS} 760 -1700 0 0 1 1 {}
  ...
  foreach var2 $&vg_vec
    ...
    foreach var3 $&vd_vec
      ...
      foreach var4 $&vb_vec
        alter vsb $var4
	run 
	wrdata techsweep_sg13g2_hv_nmos.txt noise1.all
	destroy all
	set appendwrite
...
C {devices/ngspice_get_value.sym} 1580 -950 0 1 {name=r2 node=@n.xm1.nsg13_hv_nmos[gds]
descr="gds="}
C {devices/ngspice_get_value.sym} 1580 -980 0 1 {name=r4 node=@n.xm1.nsg13_hv_nmos[gm]
descr="gm="}
C {devices/ngspice_get_value.sym} 1580 -920 0 1 {name=r5 node=v(@n.xm1.nsg13_hv_nmos[vth])
descr="vth="}
C {devices/ngspice_get_value.sym} 1580 -860 0 1 {name=r6 node=@n.xm1.nsg13_hv_nmos[cgg]
descr="cgs="}
C {devices/ngspice_get_value.sym} 1580 -890 0 1 {name=r7 node=v(@n.xm1.nsg13_hv_nmos[vdss])
descr="vdss(vds_sat)="}
C {devices/ngspice_get_value.sym} 1580 -830 0 1 {name=r8 node=v(@n.xm1.nsg13_hv_nmos[fug])
descr="fug(f_t)="}
C {devices/ngspice_get_value.sym} 1580 -800 0 1 {name=r9 node=@n.xm1.nsg13_hv_nmos[cgd]
descr="cdg="}
C {devices/ngspice_get_value.sym} 1580 -740 0 1 {name=r10 node=v(@n.xm1.nsg13_hv_nmos[sid])
descr="sid="}
C {devices/ngspice_get_value.sym} 1580 -770 0 1 {name=r11 node=v(@n.xm1.nsg13_hv_nmos[rg])
descr="rg="}
...
C {sg13g2_pr/sg13_hv_nmos.sym} 1140 -890 0 0 {name=M1
l=\{lx\}
w=\{wx\}
ng=1
m=1
