...
S {}
E {}
T {Techsweep for the SG13G2 HV PMOS} 800 -1700 0 0 1 1 {}
N 1060 -940 1060 -890 {
lab=g}
N 1060 -890 1130 -890 {
lab=g}
...
C {devices/ngspice_get_value.sym} 1560 -1030 0 1 {name=r2 node=@n.xm1.nsg13_hv_pmos[gds]
descr="gds="}
C {devices/ngspice_get_value.sym} 1560 -1060 0 1 {name=r4 node=@n.xm1.nsg13_hv_pmos[gm]
descr="gm="}
C {devices/ngspice_get_value.sym} 1560 -1000 0 1 {name=r5 node=v(@n.xm1.nsg13_hv_pmos[vth])
descr="vth="}
C {devices/ngspice_get_value.sym} 1560 -940 0 1 {name=r6 node=@n.xm1.nsg13_hv_pmos[cgg]
descr="cgs="}
C {devices/ngspice_get_value.sym} 1560 -970 0 1 {name=r7 node=v(@n.xm1.nsg13_hv_pmos[vdss])
descr="vdss(vds_sat)="}
C {devices/ngspice_get_value.sym} 1560 -910 0 1 {name=r8 node=v(@n.xm1.nsg13_hv_pmos[fug])
descr="fug(f_t)="}
C {devices/ngspice_get_value.sym} 1560 -880 0 1 {name=r9 node=@n.xm1.nsg13_hv_pmos[cgd]
descr="cdg="}
C {devices/ngspice_get_value.sym} 1560 -820 0 1 {name=r10 node=v(@n.xm1.nsg13_hv_pmos[sid])
descr="sid="}
C {devices/ngspice_get_value.sym} 1560 -850 0 1 {name=r11 node=v(@n.xm1.nsg13_hv_pmos[rg])
descr="rg="}
...
compose l_vec  values 0.5u 1u 5u 10u
  ...
  foreach var2 $&vg_vec
    ...
    foreach var3 $&vd_vec
      ...
      foreach var4 $&vb_vec
        alter vsb $var4
	run 
	wrdata techsweep_sg13g2_hv_pmos.txt noise1.all
	destroy all
	set appendwrite
...
C {sg13g2_pr/sg13_hv_pmos.sym} 1150 -890 0 0 {name=M1
l=\{lx\}
w=\{wx\}
ng=1
m=1
