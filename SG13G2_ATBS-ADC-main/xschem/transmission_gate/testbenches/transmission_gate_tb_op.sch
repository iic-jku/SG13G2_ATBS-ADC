...
C {devices/code_shown.sym} 280 -170 0 0 {name=MODEL only_toplevel=true
...
C {code_shown.sym} 280 -1590 0 0 {name=NGSPICE
only_toplevel=false
value="
.param temp=27
.param W_N=1u
...
descr="rg ="}
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 1200 -1000 0 0 {name=x1 W_P=\{W_P\} L_P=\{L_P\} W_N=\{W_N\} L_N=\{L_N\}}
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 1200 -680 0 0 {name=x2 W_P=1.0u L_P=0.13u W_N=1.0u L_N=0.13u}
