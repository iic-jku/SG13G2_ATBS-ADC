...
S {}
E {}
T {Testbench for Operating Point analysis - Parameterizable HV Inverter} 280 -1720 0 0 1 1 {}
T {x1 HV NMOS M2:} 1680 -870 0 0 0.4 0.4 {}
T {x1 HV PMOS M1:} 1980 -870 0 0 0.4 0.4 {}
N 1440 -720 1440 -680 {
lab=GND}
N 1020 -860 1020 -800 {
lab=vin}
...
C {code_shown.sym} 280 -1330 0 0 {name=NGSPICE1
only_toplevel=false
value="
.param temp=27
...
show n.x1.xm1.nsg13_hv_pmos
show n.x1.xm2.nsg13_hv_nmos

* Save transistor parameters
save @n.x1.xm2.nsg13_hv_nmos[vth]
save @n.x1.xm2.nsg13_hv_nmos[vgs]
save @n.x1.xm2.nsg13_hv_nmos[vds]
save @n.x1.xm2.nsg13_hv_nmos[vgt]
save @n.x1.xm2.nsg13_hv_nmos[ids]
save @n.x1.xm2.nsg13_hv_nmos[gm]
save @n.x1.xm2.nsg13_hv_nmos[gds]
save @n.x1.xm2.nsg13_hv_nmos[gmb]
save @n.x1.xm2.nsg13_hv_nmos[cgs]
save @n.x1.xm2.nsg13_hv_nmos[cgd]
save @n.x1.xm2.nsg13_hv_nmos[fug]
save @n.x1.xm2.nsg13_hv_nmos[rg]

save @n.x1.xm1.nsg13_hv_pmos[vth]
save @n.x1.xm1.nsg13_hv_pmos[vgs]
save @n.x1.xm1.nsg13_hv_pmos[vds]
save @n.x1.xm1.nsg13_hv_pmos[vgt]
save @n.x1.xm1.nsg13_hv_pmos[ids]
save @n.x1.xm1.nsg13_hv_pmos[gm]
save @n.x1.xm1.nsg13_hv_pmos[gds]
save @n.x1.xm1.nsg13_hv_pmos[gmb]
save @n.x1.xm1.nsg13_hv_pmos[cgs]
save @n.x1.xm1.nsg13_hv_pmos[cgd]
save @n.x1.xm1.nsg13_hv_pmos[fug]
save @n.x1.xm1.nsg13_hv_pmos[rg]

* Operating Point Analysis
op
remzerovec
write inverter_hv_tb_op.raw
set appendwrite

quit
.endc"}
C {devices/ngspice_get_value.sym} 2120 -720 0 0 {name=r43
node=v(@n.x1.xm1.nsg13_hv_pmos[fug])
descr="fug(f_t) ="}
C {devices/ngspice_get_value.sym} 2120 -760 0 0 {name=r44
node=@n.x1.xm1.nsg13_hv_pmos[cgd]
descr="cgd ="}
C {devices/ngspice_get_value.sym} 2120 -680 0 0 {name=r46
node=v(@n.x1.xm1.nsg13_hv_pmos[rg])
descr="rg ="}
C {devices/ngspice_get_value.sym} 1660 -800 0 0 {name=r2 
node=v(@n.x1.xm2.nsg13_hv_nmos[vth])
descr="vth ="}
C {devices/ngspice_get_value.sym} 1740 -800 0 0 {name=r3 
node=i(@n.x1.xm2.nsg13_hv_nmos[ids])
descr="ids ="}
C {devices/ngspice_get_value.sym} 1660 -760 0 0 {name=r4
node=v(@n.x1.xm2.nsg13_hv_nmos[vgs])
descr="vgs ="}
C {devices/ngspice_get_value.sym} 1740 -680 0 0 {name=r5 
node=@n.x1.xm2.nsg13_hv_nmos[gmb]
descr="gmb ="}
C {devices/ngspice_get_value.sym} 1820 -800 0 0 {name=r6
node=@n.x1.xm2.nsg13_hv_nmos[cgs]
descr="cgs ="}
C {devices/ngspice_get_value.sym} 1740 -760 0 0 {name=r8 
node=@n.x1.xm2.nsg13_hv_nmos[gm]
descr="gm ="}
C {devices/ngspice_get_value.sym} 1740 -720 0 0 {name=r9 
node=@n.x1.xm2.nsg13_hv_nmos[gds]
descr="gds ="}
C {devices/ngspice_get_value.sym} 1660 -720 0 0 {name=r18
node=v(@n.x1.xm2.nsg13_hv_nmos[vds])
descr="vds ="}
C {devices/ngspice_get_value.sym} 1660 -680 0 0 {name=r19
node=v(@n.x1.xm2.nsg13_hv_nmos[vgt])
descr="vod ="}
C {devices/ngspice_get_value.sym} 1820 -720 0 0 {name=r37
node=v(@n.x1.xm2.nsg13_hv_nmos[fug])
descr="fug(f_t) ="}
C {devices/ngspice_get_value.sym} 1820 -760 0 0 {name=r47 
node=@n.x1.xm2.nsg13_hv_nmos[cgd]
descr="cgd ="}
C {devices/ngspice_get_value.sym} 1820 -680 0 0 {name=r48
node=v(@n.x1.xm2.nsg13_hv_nmos[rg])
descr="rg ="}
...
C {inverter/inverter_hv.sym} 1240 -860 0 0 {name=x1 W_P=3.0u L_P=0.50u W_N=1.0u L_N=0.50u}
