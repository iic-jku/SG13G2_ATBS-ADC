...
logy=0
linewidth_mult=3}
T {Testbench for transient analysis - Parameterizable HV Inverter} 480 -1720 0 0 1 1 {}
N 1260 -700 1260 -660 {
lab=GND}
N 840 -840 840 -780 {
lab=vin}
...
C {devices/vsource.sym} 720 -750 0 0 {name=VDD value=3.3}
...
C {devices/vsource.sym} 840 -750 0 0 {name=vin value="pulse(0, 3.3, 0, 1n, 1n, 100n, 200n)"}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/inverter_hv_tb_tran.raw tran"
}
...
C {inverter/inverter_hv.sym} 1060 -840 0 0 {name=x1 W_P=3.0u L_P=0.50u W_N=1.0u L_N=0.50u}
