...
S {}
E {}
T {Parameterizable Level-Down-Shifter} 800 -1720 0 0 1 1 {}
...
HV NMOS width is always 1um for good matching. LV PMOS width is always 3um for good matching. LV NMOS width is 10um in latch and 1um in output inverter.} 160 -1560 0 0 0.5 0.5 {}
...
C {inverter/inverter_lv.sym} 1800 -860 0 0 {name=x3 W_P=W_P_LV L_P=L_P_LV W_N=0.1*W_N_LV L_N=L_N_LV}
C {inverter/inverter_hv.sym} 720 -710 0 0 {name=x1 W_P=W_P_HV L_P=L_P_HV W_N=W_N_HV L_N=L_N_HV}
C {inverter/inverter_hv.sym} 1500 -710 0 1 {name=x2 W_P=W_P_HV L_P=L_P_HV W_N=W_N_HV L_N=L_N_HV}
C {sg13g2_pr/sg13_lv_nmos.sym} 1000 -710 0 0 {name=M1
l=L_N_LV
w=W_N_LV
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1040 -930 0 1 {name=M3
l=L_P_LV
w=W_P_LV
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1280 -710 0 1 {name=M2
l=L_N_LV
w=W_N_LV
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1240 -930 0 0 {name=M4
l=L_P_LV
w=W_P_LV
ng=1
m=1
