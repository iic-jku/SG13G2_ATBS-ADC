...
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 1240 -1440 3 1 {name=x1 W_P=W_P_VCM L_P=L_P_VCM W_N=W_N_VCM L_N=L_N_VCM}
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 1420 -1260 0 0 {name=x2 W_P=W_P_VCM L_P=L_P_VCM W_N=W_N_VCM L_N=L_N_VCM}
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 1240 -740 3 1 {name=x3 W_P=W_P_VCM L_P=L_P_VCM W_N=W_N_VCM L_N=L_N_VCM}
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 1420 -560 0 0 {name=x4 W_P=W_P_VCM L_P=L_P_VCM W_N=W_N_VCM L_N=L_N_VCM}
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 940 -580 3 1 {name=x5 W_P=W_P_VCM L_P=L_P_VCM W_N=W_N_VCM L_N=L_N_VCM}
...
C {inverter/inverter_lv.sym} 600 -1540 0 0 {name=x9 W_P=W_P_VCM L_P=L_P_VCM W_N=W_N_VCM L_N=L_N_VCM}
...
C {inverter/inverter_lv.sym} 600 -1280 0 0 {name=x8 W_P=W_P_VCM L_P=L_P_VCM W_N=W_N_VCM L_N=L_N_VCM}
