...
N 740 -1040 740 -1020 {lab=#net1}
N 740 -1120 740 -1100 {lab=vin}
...
C {devices/vsource.sym} 740 -1070 0 0 {name=vin value="pulse(0, 3.3, 0, 1m, 1m, 1m, 3m)"}
...
descr="Load waves" 
tclcommand="xschem raw_read $netlist_dir/schmitt_trigger_tb_tran_noise.raw tran"
}
...
C {code_shown.sym} 80 -950 0 0 {name=NGSPICE
only_toplevel=true
value="
.param temp=27
.param W_N=1u
...
op
remzerovec
write schmitt_trigger_tb_tran_noise.raw
set appendwrite
...
set wr_singlescale
set wr_vecnames
wrdata /foss/designs/SG13G2_ATBS-ADC-main/python/plot_simulations/data/schmitt_trigger_tb_tran_noise.txt v(vin) v(vout_buf) v(vout_st)
...
C {devices/vsource.sym} 740 -990 0 0 {name=vnoise value="DC 0 TRNOISE(300m 1u 0 0)"}
